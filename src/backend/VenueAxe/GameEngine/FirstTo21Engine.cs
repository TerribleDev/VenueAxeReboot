...
/// <summary>
/// First to 21: Target exactly 21 points!
/// Going over 21 is a BUST that penalizes the thrower back to 13.
/// First player to reach exactly 21 wins instantly.
/// </summary>
public class FirstTo21Engine : IGameEngine
{
    public string GameTypeId => "first_to_21";
    public string DisplayName => "First to 21";
    public string Description => "Target exactly 21! Standard rings add 1-6 points (Killshot adds 8). Over 21 busts back to 13. First to 21 wins!";
    ...
    public string ScoringRules => "Bullseye = 6 pts, Ring 5 = 5 pts, Ring 4 = 4 pts, Ring 3 = 3 pts, Ring 2 = 2 pts, Ring 1 = 1 pt. Killshot = 8 pts.";
    public string SpecialRules => "Busting: If any throw pushes your total score above 21, you BUST! Your score drops back to 13, and you must carefully shoot for the remaining points.";
        ...
        bool isClutchCalled)
    {
        ...
        if (zone == TargetZone.KillLeft || zone == TargetZone.KillRight || zone == TargetZone.ClutchLeft || zone == TargetZone.ClutchRight) player.ClutchesHit++;
    ...
    public GameStateSnapshot UndoLastThrow(GameStateSnapshot state)
    {
        ...
        foreach (var t in state.AllThrows)
        {
            ...
            if (p != null)
            {
                ...
                p.Score = nextScore > 21 ? 13 : nextScore;
                p.ThrowsTaken++;
